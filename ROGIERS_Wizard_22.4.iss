...
OutputBaseFilename=ROGIERS Wizard 22.4
...
begin
  CustomQueryPage := CreateInputQueryPage(wpWelcome,
    ...
    'Dit wordt gebruikt om een map te creëren in "C:\ROGIERS\BACKUPS" op datum van vandaag. Vervolgens wordt automatisch een map gemaakt zoals : "2022.05.04 DVH". Plaats nadien hierin uw DAGRAPPORT.');
