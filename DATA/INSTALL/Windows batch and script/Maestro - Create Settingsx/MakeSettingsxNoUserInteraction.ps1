...
$targetfolder = "C:\ROGIERS\BACKUPS"    #Path is fixed when using this 'NoInteraction' version of the script
...
# indien pad niet beschikbaar, neem data uit public documents als backup [no user interaction / always use the PUBLIC documents data if correct path is not available]
...
if (Test-Path -Path $node1) {
    ...
    Write-Host "ATRX Path not found. Creating settings from public documents folder......." -ForegroundColor black -BackgroundColor Red
...
if (Test-Path -Path $node2) {
    ...
    Write-Host "CFGX Path not found. Creating settings from public documents folder......." -ForegroundColor black -BackgroundColor Red
...
if (Test-Path -Path $node3) {
    ...
    Write-Host "EDGX Path not found. Creating settings from public documents folder......." -ForegroundColor black -BackgroundColor Red
...
if (Test-Path -Path $node4) {
    ...
    Write-Host "MACROS Path not found. Creating settings from public documents folder......." -ForegroundColor black -BackgroundColor Red
...
if (Test-Path -Path $node5) {
    ...
    Write-Host "TECHNOLOGIES Path not found. Creating settings from public documents folder......." -ForegroundColor black -BackgroundColor Red
...
if (Test-Path -Path $node6) {
    ...
    Write-Host "TLGX Path not found. Creating settings from public documents folder......." -ForegroundColor black -BackgroundColor Red
...
if (Test-Path -Path $node7) {
    ...
    Write-Host "TOOLSWEAR Path not found. Creating settings from public documents folder......." -ForegroundColor black -BackgroundColor Red
