...
OutputDir=F:\MEGASYNC\ROGIERS-Wizard\TEST_BUILDS 
...
Source: "DATA\INSTALL\ROGIERS Wizard\SCRIPTS\13___1_ChangeLanguage_NL1.bat"; DestDir: "{tmp}"; Permissions: everyone-full; BeforeInstall: BeforeInstall_NL1
...
begin
        ...
        Exec('""C:\ROGIERS\INSTALL\ROGIERS Wizard\SCRIPTS\13___1_ChangeLanguage_NL1.bat"""','', '', SW_SHOW, ewWaitUntilTerminated, ResultCode);         
        end;
end;
