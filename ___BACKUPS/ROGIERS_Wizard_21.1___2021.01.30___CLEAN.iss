...
begin
  ...
  begin      
    ...
    begin
      MsgBox('De Windows wordt nu gewijzigd naar: NEDERLANDS - QWERTY toetsenbord (SCM origineel)', mbInformation, MB_OK);
    end;
    if CheckListBox.Checked[NL2] then
    begin
      MsgBox('De Windows wordt nu gewijzigd naar: NEDERLANDS - AZERTY toetsenbord', mbInformation, MB_OK);
    end;
    if CheckListBox.Checked[FR1] then
    begin
      MsgBox('De Windows wordt nu gewijzigd naar: FRANS - QWERTY toetsenbord (SCM origineel)', mbInformation, MB_OK);
    end;
    if CheckListBox.Checked[FR2] then
    begin
      MsgBox('De Windows wordt nu gewijzigd naar: FRANS - AZERTY toetsenbord', mbInformation, MB_OK);
    end;
