...
OutputBaseFilename=ROGIERS Wizard 21.4
...
begin
  CustomQueryPage := CreateInputQueryPage(wpWelcome,
    ...
    'Dit wordt gebruikt om een map te creëren in "C:\ROGIERS\BACKUPS" op datum van vandaag. Vervolgens zal automatisch een map aangemaakt worden zoals : "2021.05.04 DVH". Plaats nadien hierin uw DAGRAPPORT.');
